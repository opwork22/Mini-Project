...
# BASE DIRECTORY (outside the file)
BASE_DIR = "/home/om-panchpatkar/Desktop/Python/Mini project"

# FILE PATHS
FILE_NAME = os.path.join(BASE_DIR, "student.csv")
...
def write_csv():
    ...
    """
    try:
        students =  [   ["Roll No", "Name", "Science", "Maths", "English", "History", "Computer", "City", "Sports"],
    ...
    [40, "SNEHA", None, 105, 90, -3, 88, "Guna", ""],
    [42, "Rohini", 66, 68, 70, 65, None, " ", "Basketball"],
    [43, "Dev", 88, 92, None, 85, 90, "Indore", "Cricket"],
    [44, "Isha", -20, 55, 60, 58, 62, "Bhopal", "Tennis"],
    [45, "Manoj", 75, 77, 74, 72, 76, "Sehore", "kabaddi"],
    [46, "Kriti", None, None, 82, 80, 85, "Ratlam", "Badminton"],
    [47, "Alok", 100, 100, 100, 100, 100, "Indore", "Cricket"],
    [48, "Payal", 5, 15, 10, 8, 12, " ", "Hockey"],
    [49, "Ramesh", 65, 70, 68, 66, 72, None, "Football"],
    [50, "Anu", 85, None, 88, 90, 92, "Bhilai", "Tennis"]
]
...
def append_csv():
    ...
    try:
        ...
        logging.error(f"Error while appending data: {e}")
